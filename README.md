...
# 浏览器打开 Vite 地址（默认 http://127.0.0.1:9175 ）
```

- 健康检查: `GET http://127.0.0.1:8905/api/health`
- 代理: 前端 `/api` → `http://127.0.0.1:8905`；改端口时同步 `backend/.env` 与 `frontend/.env.development`
